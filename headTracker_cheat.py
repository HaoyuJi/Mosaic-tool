...
def parse_args():
    ...
    parser.add_argument('--cheat_path', type=str, help='Video file for evaluation.')
...
if __name__ == '__main__':
    ...
    for video in video_paths:
        ...
        cap_cheat = cv2.VideoCapture(args.cheat_path)
        ...
        while True:
            ...
            ret, frame = cap.read()
            ret_cheat,frame_cheat =cap_cheat.read()
            if ret:

                headBoxes = headModel.inference(frame_cheat.copy())
